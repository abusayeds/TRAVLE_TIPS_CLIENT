      ...
      <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
        ...
        <div className="mt-16 w-full grid lg:grid-cols-3 grid-cols-1 gap-12">
          ...
          <div className="flex flex-col items-center bg-white rounded-lg shadow-lg p-6">
            ...
            <button className="mt-4 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-800">
              Learn More
            </button>
          </div>
        ...
        >
          ...
          <motion.p
            className="text-gray-500 text-base mb-8 text-center"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
