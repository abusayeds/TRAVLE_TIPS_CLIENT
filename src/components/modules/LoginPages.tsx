...
import ForgetPasswordModel from "@/src/app/(withCommonLayout)/forgetPassword/page";
import PasswordChangeModal from "@/src/app/(withCommonLayout)/changePasseord/page";
